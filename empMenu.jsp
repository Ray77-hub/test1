...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="empHome.jsp" style="height:16px;line-height:16px;">本次評核</a></li>
	<li class="topmenu"><a href="empQuery.jsp" style="height:16px;line-height:16px;"><span>查詢評核</span></a>
