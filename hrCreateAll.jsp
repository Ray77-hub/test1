...
String WK_FileName = userInformation.getYear() + userInformation.getItem() + userInformation.getId() + "HR40C.pdf";///
...
///
	...
	out.println("<button class='button' onclick=\"document.location.href='hrQuery.jsp'\">回本次評核畫面</button>");
}
%>